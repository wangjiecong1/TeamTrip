---
name: teamtrip-visual-design
description: Apply TeamTrip's global visual design specification (主色 #00A889 青绿色、白色大圆角卡片 20-28px、胶囊标签、轻阴影、浅色旅行背景、清爽协作风格) when creating or modifying any frontend UI code in this project — pages, components, modals, drawers, popovers, forms, cards, buttons, tags, empty states, charts, icons, navigation, etc. Invoke this skill before any UI change to align with the project's design tokens and to run the 14-point self-check. Scope is visual design only; functional flow, business logic, and API behavior are governed by the current PRD and project code.
---

# TeamTrip 全局视觉设计规范 Skill(Claude Code 版本)

> 本文件为 Claude Code 适配版本。
> Codex 版本保留在 `docs/skills/teamtrip-visual-design/SKILL.md`,未做改动。
> 两份在视觉规则上保持一致,仅在"调用方自检"措辞上分别面向 Claude Code 与 Codex。
